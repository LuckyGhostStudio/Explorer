...
namespace Explorer
{
	void Light::SetIcon()
	{
		...
		case Type::Directional:
			m_Icon = std::make_shared<Texture2D>("Resources/Icons/Components/DirectionalLight_Icon.png");
			break;
		case Type::Point:
			m_Icon = std::make_shared<Texture2D>("Resources/Icons/Components/PointLight_Icon.png");
			break;
		case Type::Spot:
			m_Icon = std::make_shared<Texture2D>("Resources/Icons/Components/SpotLight_Icon.png");
			break;
		}
	}
